...
Section~\ref{sec:secondary} are stated numerically in the main text; their figures are placed here.
...
numeric reader. Stratum composition is annotated on the panels; see Section~\ref{sec:secondary}.}
\label{fig:cuesuff}
\end{figure}
