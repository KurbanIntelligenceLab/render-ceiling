...
the retired below-baseline claim (Section~\ref{sec:models}), the retracted unpaired
minimum-detectable-difference (Section~\ref{sec:conventions}), the withdrawn stratified-accuracy mechanism
(Section~\ref{sec:secondary}), and the three documented non-recoveries (Limitations).
